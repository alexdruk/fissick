...
Expected substring: "FOSSICK"
Received string:    "Fossick · Local-first archive tool"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.import-eyebrow-bar')
    5 × locator resolved to <div class="import-eyebrow-bar">Fossick · Local-first archive tool</div>
      - unexpected value "Fossick · Local-first archive tool"

```

```yaml
- text: Fossick · Local-first archive tool
```
